...
// cs144 为了讲课的循序渐进，将 TCP 分为了 发送者和接收者，二者都有自己状态和逻辑
class TCPConnection {
  private:
    TCPConfig _cfg;                                                          // TCP 配置
    TCPReceiver _receiver{_cfg.recv_capacity};                               // 接收者
    TCPSender _sender{_cfg.send_capacity, _cfg.rt_timeout, _cfg.fixed_isn};  // 发送者
    ...
    bool _linger_after_streams_finish{true};  // 数据流完成后是否继续保持活跃
